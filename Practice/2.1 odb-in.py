...
t = p.MakeSketchTransform(sketchPlane=f[0], sketchPlaneSide=SIDE1, origin=(0.0, 24.95992, 0.0))
...
mdb.models['Model-1'].materials['Material-Soil'].Elastic(table=((15000000.0, 0.4), ))
